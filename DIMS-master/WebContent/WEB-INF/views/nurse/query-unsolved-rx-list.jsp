...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>查看未处理处方列表 - 基于SSM的药店销售管理系统</title>
		<meta name="description" content="查看未处理处方列表 - 基于SSM的药店销售管理系统" />
														...
														<tr>
															...
															<td>
																<div class="hidden-sm hidden-xs action-buttons">
																	...
																	<a class="green" href="../nurse/handle-rx-form?Pno=${rx.pno}" title="处理该处方">
																...
																<div class="hidden-md hidden-lg">
																	<div class="inline pos-rel">
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																			...
																			<li>
																				<a href="../nurse/handle-rx-form?Pno=${rx.pno}" class="tooltip-success" data-rel="tooltip" title="处理该处方">
																					<span class="green">
